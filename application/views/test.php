                    ...
                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 item grid-view-item style2">
                        <div class="grid-view_image">
                            ...
                            <a href="product-accordion.html" class="grid-view-item__link">
                                <!-- image -->
                                <img class="grid-view-item__image primary blur-up lazyload"
                                    data-src="<?php echo base_url(); ?>assets/images/product-images/product-image16.jpg"
                                    src="<?php echo base_url(); ?>assets/images/product-images/product-image16.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="grid-view-item__image hover blur-up lazyload"
                                    data-src="<?php echo base_url(); ?>assets/images/product-images/product-image16-1.jpg"
                                    src="<?php echo base_url(); ?>assets/images/product-images/product-image16-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
